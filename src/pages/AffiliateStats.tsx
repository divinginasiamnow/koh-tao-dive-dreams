        ...
        <Card className="mb-8">
          ...
          <CardContent>
            {loading ? (
              ...
              <p className="text-gray-500 text-center py-8">No clicks yet. Share your <a href="/accommodation-booking" className="text-blue-600 underline">accommodation page</a> to start earning!</p>
            ) : (
                ...
                {hotelStats.map((stat, i) => (
                  <div key={stat.hotel_name} className="flex items-center gap-4 p-3 bg-gray-50 rounded-lg">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <Badge className="bg-blue-100 text-blue-800 min-w-[40px] justify-center">
                        {stat.clicks}
                      </Badge>
                    </div>
                  </div>
